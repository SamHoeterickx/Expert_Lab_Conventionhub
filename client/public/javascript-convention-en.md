...
- Write **clear, consistent, and logical** code.
- Avoid unnecessary complexity.
- Code should be readable by others — not just by you.
...
- Leave **blank lines** between logical code blocks.
...
### Use Strict Equality
- Always use `===` and `!==` instead of `==` or `!=`.
  ```js
  if (value === 0) { ... }
  ```

### Avoid Global Variables
- Use modules or functions to limit scope.
...
**Author:** [Team or Organization Name]
